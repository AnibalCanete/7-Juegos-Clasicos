...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function controlBoard() {
        for (let y = 0; y < winnersArrays.length; y++) {
            const square1 = squares[winnersArrays[y][0]];
            const square2 = squares[winnersArrays[y][1]];
            const square3 = squares[winnersArrays[y][2]];
            const square4 = squares[winnersArrays[y][3]];
